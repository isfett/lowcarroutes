...
/*! all exports used */
/***/
function(t,e,n){"use strict";var o=(n(/*! core-decorators */"./node_modules/core-decorators/es/core-decorators.js"),n(/*! ./components/Map */"./assets/js/components/Map.js")),r=function(t){return t&&t.__esModule?t:{default:t}}(o),i=n(/*! jquery */"./node_modules/jquery/dist/jquery.js");if(n(/*! bootstrap-sass */"./node_modules/bootstrap-sass/assets/javascripts/bootstrap.js"),i("#map").size()){var s=new r.default(MAPQUEST_APIKEY,"map",API_PATHS.speedbump);s.setCenter([-74.0059,40.7128]),s.setZoom(12),s.setPitch(60),s.setStart("350 5th Ave, New York, NY 10118"),s.setDestination("One Liberty Plaza, New York, NY 10006"),s.load()}},/***/
...
(function(t){function o(t){return t&&t.__esModule?t:{default:t}}function r(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(e,"__esModule",{value:!0}),e.Map=void 0;var i=function(){function t(t,e){for(var n=0;n<e.length;n++){var o=e[n];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(t,o.key,o)}}return function(e,n,o){return n&&t(e.prototype,n),o&&t(e,o),e}}(),s=n(/*! axios */"./node_modules/axios/index.js"),a=o(s),l=n(/*! ./SpeedBump */"./assets/js/components/SpeedBump.js"),u=o(l),c=function(){function e(n,o,i){if(r(this,e),this.options={zoom:12,pitch:0,bearing:0,directions:{ribbon:{showTraffic:!1}}},this.speedbumps=[],void 0===n||void 0===o||void 0===i)throw new Error('"MAPQUEST_APIKEY", "id" and "route" are required.');this.mapquest_apikey=n,this.id=o,this.element=t("#"+this.id),this.route=i,this.loadSpeedBumps()}return i(e,[{key:"loadSpeedBumps",value:function(){var t=this;a.default.get(this.route).then(function(e){console.log("response",e);var n=!0,o=!1,r=void 0;try{for(var i,s=e.data[Symbol.iterator]();!(n=(i=s.next()).done);n=!0){var a=i.value;console.log("data",a),t.speedbumps.push(new u.default(a))}}catch(t){o=!0,r=t}finally{try{!n&&s.return&&s.return()}finally{if(o)throw r}}}).catch(function(t){console.log(t)})}},{key:"getOptions",value:function(){return this.options}},{key:"getOption",value:function(t){if(t in this.options)return this.options[t]}},{key:"setCenter",value:function(t){if(!Array.isArray(t))throw new Error('"center" must be an array.');if(2!==t.length)throw new Error('"center" array needs exaclty 2 values.');var e=!0,n=!1,o=void 0;try{for(var r,i=t[Symbol.iterator]();!(e=(r=i.next()).done);e=!0){var s=r.value,a=parseFloat(s);if(isNaN(a))throw new Error('"center" array has non-float values.')}}catch(t){n=!0,o=t}finally{try{!e&&i.return&&i.return()}finally{if(n)throw o}}this.options.center=t}},{key:"setZoom",value:function(t){if("number"!=typeof t)throw new Error('"zoom" must be a number.');this.options.zoom=t}},{key:"setPitch",value:function(t){if("number"!=typeof t)throw new Error('"pitch" must be a number.');this.options.pitch=t}},{key:"setBearing",value:function(t){if("number"!=typeof t)throw new Error('"bearing" must be a number.');this.options.bearing=t}},{key:"setStart",value:function(t){this.start=t}},{key:"setDestination",value:function(t){this.destination=t}},{key:"getRoute",value:function(){if(void 0===this.start||void 0===this.destination)throw new Error('You are not allowed to call "getRoute()" when there is no start and destination point.');return[this.start,this.destination]}},{key:"load",value:function(){this.map=new mqgl.Map(this.id,this.mapquest_apikey,this.options),this.start&&this.destination&&this.createRoute()}},{key:"fitBounds",value:function(){this.map.fitBounds()}},{key:"createRoute",value:function(){var t=this;this.map.load(function(){t.map.directions.route(t.getRoute()).then(function(e){console.log("data",e),t.fitBounds()})})}},{key:"hide",value:function(){this.element.hide()}},{key:"show",value:function(){this.element.show()}},{key:"disableTrafic",value:function(){}}]),e}();e.Map=c,e.default=c}).call(e,n(/*! jquery */"./node_modules/jquery/dist/jquery.js"))},/***/
...
/*! all exports used */
/***/
function(t,e,n){"use strict";function o(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(e,"__esModule",{value:!0}),e.SpeedBump=void 0;var r=function(){function t(t,e){for(var n=0;n<e.length;n++){var o=e[n];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(t,o.key,o)}}return function(e,n,o){return n&&t(e.prototype,n),o&&t(e,o),e}}(),i=n(/*! ./Point */"./assets/js/components/Point.js"),s=function(t){return t&&t.__esModule?t:{default:t}}(i),a=function(){function t(e){o(this,t),this.statuses={registered:1,confirmed:2,reported:3,deleted:4},this.id=e.id,this.height=e.height,this.point=new s.default(e.point),this.status=e.status}return r(t,[{key:"getId",value:function(){return this.id}},{key:"getHeight",value:function(){return this.height}},{key:"getPoint",value:function(){return this.point}},{key:"getStatus",value:function(){return this.status}},{key:"getStatusLabel",value:function(){}},{key:"setStatus",value:function(){}}]),t}();e.SpeedBump=a,e.default=a},/***/
...
"test"===e.env.NODE_ENV||"undefined"==typeof window||!window.XDomainRequest||"withCredentials"in h||a(t.url)||(h=new window.XDomainRequest,m="onload",v=!0,h.onprogress=function(){},h.ontimeout=function(){}),t.auth){var g=t.auth.username||"",y=t.auth.password||"";p.Authorization="Basic "+u(g+":"+y)}
// Add xsrf header
 ...
 */
function g(t){return t.replace(/^\s*/,"").replace(/\s*$/,"")}/**
 ...
 */
function j(t,e,n){return b(e,function(e,o){t[o]=n&&"function"==typeof e?x(e,n):e}),t}var x=n(/*! ./helpers/bind */"./node_modules/axios/lib/helpers/bind.js"),T=n(/*! is-buffer */"./node_modules/is-buffer/index.js"),_=Object.prototype.toString;t.exports={isArray:o,isArrayBuffer:r,isBuffer:T,isFormData:i,isArrayBufferView:s,isString:a,isNumber:l,isObject:c,isUndefined:u,isDate:d,isFile:f,isBlob:p,isFunction:h,isStream:m,isURLSearchParams:v,isStandardBrowserEnv:y,forEach:b,merge:w,extend:j,trim:g}},/***/
...
var g=n(/*! ./time */"./node_modules/core-decorators/es/time.js");/* harmony reexport (binding) */
n.d(e,"time",function(){return g.a});/* harmony import */
var y=n(/*! ./extendDescriptor */"./node_modules/core-decorators/es/extendDescriptor.js");/* harmony reexport (binding) */
n.d(e,"extendDescriptor",function(){return y.a});/* harmony import */
...
/*! exports used: default */
/***/
function(t,e,n){"use strict";function o(t){if(Array.isArray(t)){for(var e=0,n=Array(t.length);e<t.length;e++)n[e]=t[e];return n}return Array.from(t)}function r(t){return Array.isArray(t)?t:Array.from(t)}function i(t,e,n,i){var s=r(i),u=s[0],c=s.slice(1),d=n.configurable,f=n.enumerable,p=n.writable,h=n.get,m=n.set,v=n.value,g=!!h;return{configurable:d,enumerable:f,get:function(){var t=g?h.call(this):v,n=u.call.apply(u,[this,t].concat(o(c)));if(g)return n;var r={configurable:d,enumerable:f};return r.value=n,r.writable=p,l(this,e,r),n},set:g?m:Object(a.b)()}}function s(){for(var t=arguments.length,e=Array(t),n=0;n<t;n++)e[n]=arguments[n];return Object(a.c)(i,e)}/* harmony export (immutable) */
...
var h,m,v,g,y,b,w=n(/*! ../lazy-initialize */"./node_modules/core-decorators/es/lazy-initialize.js"),j="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},x=Object.defineProperty,T=Object.getOwnPropertyDescriptor,_=Object.getOwnPropertyNames,O=Object.getOwnPropertySymbols,S=(h=function t(){r(this,t),o(this,"debounceTimeoutIds",m,this),o(this,"throttleTimeoutIds",v,this),o(this,"throttlePreviousTimestamps",g,this),o(this,"throttleTrailingArgs",y,this),o(this,"profileLastRan",b,this)},m=i(h.prototype,"debounceTimeoutIds",[w.a],{enumerable:!0,initializer:function(){return{}}}),v=i(h.prototype,"throttleTimeoutIds",[w.a],{enumerable:!0,initializer:function(){return{}}}),g=i(h.prototype,"throttlePreviousTimestamps",[w.a],{enumerable:!0,initializer:function(){return{}}}),y=i(h.prototype,"throttleTrailingArgs",[w.a],{enumerable:!0,initializer:function(){return null}}),b=i(h.prototype,"profileLastRan",[w.a],{enumerable:!0,initializer:function(){return null}}),h),$="function"==typeof Symbol?Symbol("__core_decorators__"):"__core_decorators__",E=O?function(t){return _(t).concat(O(t))}:_,C=function(){return"object"===("undefined"==typeof console?"undefined":j(console))&&console&&"function"==typeof console.warn?f(console.warn,console):function(){}}(),k={}},/***/

...
if (isset($_SERVER['HTTP_CLIENT_IP'])
    ...
    || !(in_array(@$_SERVER['REMOTE_ADDR'], ['127.0.0.1', 'fe80::1', '::1','172.20.0.1','172.24.0.2','172.18.0.1','172.18.0.2','172.22.0.1','172.22.0.2','172.18.0.3','172.24.0.1','172.24.0.3'], true) || PHP_SAPI === 'cli-server')
) {
